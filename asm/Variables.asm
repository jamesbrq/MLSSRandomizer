	...
	BC_UNLOCK_RAM equ 0x02003004
	POPPLE2_DEFEAT_RAM equ 0x02003005
    ...
    BORDER_RAM equ 0x0200302D
    SHOP_COUNT equ 0x0200302C
	...
	POST_BIRDO_CASTLE_FIX equ 0x08E06E00
	POST_BIRDO_BEANSTAR_FIX equ 0x08E06F00
	HAMMERHEAD_FIX equ 0x08E07000
    ROSE_WARNING equ 0x08E09F00
    CHUCKLISSA_WARNING equ 0x08E09F50
    WARNING equ 0x08E0A000
    PIRANHA_BEAN_PATCH equ 0x0822CE93
    BLABLANADON equ 0x08E0A200
    ...
    EMBLEMS equ 0x020048FB
    INFINITE_WATER_HOOK equ 0x080319E8
    INFINITE_WATER_SUBR equ 0x081DFD60
    WIGGLER_FIX equ 0x08E01F80