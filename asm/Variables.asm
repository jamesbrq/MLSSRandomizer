    ...
    BPIECE_FIX_SUBR equ 0x081DF590
    BEANSTAR_TEXT equ 0x081DFDC0
    BEANSTAR_OPTION equ 0x081E1EEE
    ...
    HSPRITE_FIX_SUBR equ 0x081DE850
    SEWER_BLOCK equ 0x081E0B70
    PEACH_KIDNAPPED equ 0x081E04D0
    RUINS_DOORS equ 0x081DDAF0
    FAWFUL_FLAGS equ 0x08E00000
    GWAHAR_PIPE equ 0x08E00060
    YOSHI_TEXT_FIX_HOOK equ 0x080E9BF4
    YOSHI_TEXT_FIX_SUBR equ 0x081DEDA0
    SPANGLE_SUBR equ 0x08E00100
    SPANGLE_RAM equ 0x0200300D
    GATES_RAM equ 0x0200300F
    CASTLE_GATES equ 0x08E00300
    WINKLE_RAM equ 0x02003014
