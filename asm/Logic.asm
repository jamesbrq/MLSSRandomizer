    ...
    .org 0x08201F30 ;Expand inv. by 1 for emblems
        db 0x1A
    ...
    .org EMBLEM_TEXT_HOOK
        bl EMBLEM_TEXT_SUBR
        
    .org EMBLEM_DESC_HOOK
        bl EMBLEM_DESC_SUBR
    ...
    .org EMBLEM_TEXT_SUBR
    push lr
    ldr r1, =0x03007BE4
    ldrb r1, [r1]
    cmp r1, #0x19
    bne .e_norm
    ldr r1, =EMBLEM_INV_HOOK
    bl .e_end
    .e_norm:
    ldrb r1, [r5]
    lsl r1, r1, #0x2
